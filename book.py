...
@app.route("/book/<string:isbn13>") # 'string:' is optional 
...
@app.route("/book/<string:isbn13>", methods=['POST']) # default is get if it is not specified
def create_book(isbn13):
    ...
    book = Book(isbn13, **data) # any data that is being sent
